...
myawesomemenu = {
    { "sleep", function() awful.util.spawn_with_shell("xautolock -locknow && systemctl suspend") end },
}

mymainmenu = awful.menu({
    items = {
        { "power", myawesomemenu, beautiful.awesome_icon },
        { "Chrome", function() awful.util.spawn("chromium")  end },
        { "Music", function() awful.util.spawn("spotify") end },
        { "Code", function() awful.util.spawn("code-oss") end },
...
globalkeys = gears.table.join(
    ...
    awful.key({ modkey, "Shift" }, "s",
            function()
                awful.util.spawn_with_shell('import -window `xwininfo |grep "Window id:" |cut -d" " -f4` screenshot.jpg && chromium ~/screenshot.jpg')
            end),
...
awful.util.spawn_with_shell('/home/dan/.config/awesome/lockme.sh')
